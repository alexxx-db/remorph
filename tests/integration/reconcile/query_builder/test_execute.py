...
def test_reconcile_data_with_mismatches_and_missing(
    ...
    expected_schema_reconcile = mock_spark.createDataFrame(
        [
            Row(
                source_column_normalized="s_suppkey",
                source_column_normalized_ansi="s_suppkey",
            ...
            Row(
                source_column_normalized="s_name",
                source_column_normalized_ansi="s_name",
            ...
            Row(
                source_column_normalized="s_address",
                source_column_normalized_ansi="s_address",
                source_datatype="varchar",
            ...
            Row(
                source_column_normalized="s_nationkey",
                source_column_normalized_ansi="s_nationkey",
                source_datatype="number",
            ...
            Row(
                source_column_normalized="s_phone",
                source_column_normalized_ansi="s_phone",
                source_datatype="varchar",
            ...
            Row(
                source_column_normalized="s_acctbal",
                source_column_normalized_ansi="s_acctbal",
                source_datatype="number",
