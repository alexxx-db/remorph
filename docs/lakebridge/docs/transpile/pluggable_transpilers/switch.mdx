...
- **Existing resources**: `USE CATALOG`, `USE SCHEMA`, `CREATE TABLE`, `READ VOLUME`, `WRITE VOLUME`
- **New resources**: Catalog/schema/volume creation permissions (resources will be created automatically during installation if they don't exist)
