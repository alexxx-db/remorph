...
def execute():
    ...
    try:
        ...
        insert_df_to_duckdb(sql_pools_df, db_path, "workspace_sql_pools")
        ...
        insert_df_to_duckdb(spark_pools_df, db_path, "workspace_spark_pools")
        ...
        insert_df_to_duckdb(pipeline_runs_df, db_path, "workspace_pipeline_runs")
        ...
        insert_df_to_duckdb(trigger_runs_df, db_path, "workspace_trigger_runs")
